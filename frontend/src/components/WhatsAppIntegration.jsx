    ...
    <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-green-700 mt-1">
              Sandbox Code: <span className="font-mono bg-green-100 px-2 py-1 rounded">
                {whatsappData?.sandbox_code}
              </span>
            </p>
          </div>
          <button
      ...
      <div className="bg-white border border-gray-200 rounded-lg p-6">
        ...
        <div className="space-y-3">
          {whatsappData?.setup_instructions?.map((instruction, index) => (
          ...
          <div className={`mt-4 p-4 rounded-lg ${testResult.success ? 'bg-green-50 border border-green-200' : 'bg-red-50 border border-red-200'}`}>
            ...
            {testResult.success && testResult.transaction && (
              <div className="text-sm space-y-1 text-green-700">
                ...
                <p><strong>Merchant:</strong> {testResult.transaction.merchant}</p>
      ...
      <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-6">
        ...
        <div className="grid md:grid-cols-2 gap-4 text-sm text-yellow-700">
          <div>
            <h4 className="font-semibold mb-2">📱 Receive Bank SMS</h4>
            <p>Get transaction SMS from your bank on your phone</p>
          </div>
          <div>
            <h4 className="font-semibold mb-2">📤 Forward to WhatsApp</h4>
            <p>Simply forward the SMS to our WhatsApp number</p>
          </div>
          <div>
            <h4 className="font-semibold mb-2">🤖 Automatic Processing</h4>
            <p>Our system parses and creates the transaction instantly</p>
          </div>
          <div>
            <h4 className="font-semibold mb-2">✅ Done!</h4>
            <p>Transaction appears in your dashboard automatically</p>
          </div>
        </div>
      </div>
    </div>
